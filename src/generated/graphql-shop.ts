...
export type ManualPaymentConfig = Node & {
	__typename?: 'ManualPaymentConfig';
	...
	instructionsExtra: Scalars['String']['output'];
	phone: Scalars['String']['output'];
	updatedAt: Scalars['DateTime']['output'];
	upiId: Scalars['String']['output'];
};

export type ManualPaymentConfigFilterParameter = {
	_and?: InputMaybe<Array<ManualPaymentConfigFilterParameter>>;
	_or?: InputMaybe<Array<ManualPaymentConfigFilterParameter>>;
	accountName?: InputMaybe<StringOperators>;
	accountNumber?: InputMaybe<StringOperators>;
	bankName?: InputMaybe<StringOperators>;
	code?: InputMaybe<StringOperators>;
	createdAt?: InputMaybe<DateOperators>;
	enabled?: InputMaybe<BooleanOperators>;
	id?: InputMaybe<IdOperators>;
	ifsc?: InputMaybe<StringOperators>;
	instructionsExtra?: InputMaybe<StringOperators>;
	phone?: InputMaybe<StringOperators>;
	updatedAt?: InputMaybe<DateOperators>;
	upiId?: InputMaybe<StringOperators>;
};

export type ManualPaymentConfigList = PaginatedList & {
	__typename?: 'ManualPaymentConfigList';
	items: Array<ManualPaymentConfig>;
	totalItems: Scalars['Int']['output'];
};

export type ManualPaymentConfigListOptions = {
	/** Allows the results to be filtered */
	filter?: InputMaybe<ManualPaymentConfigFilterParameter>;
	/** Specifies whether multiple top-level "filter" fields should be combined with a logical AND or OR operation. Defaults to AND. */
	filterOperator?: InputMaybe<LogicalOperator>;
	/** Skips the first n results, for use in pagination */
	skip?: InputMaybe<Scalars['Int']['input']>;
	/** Specifies which properties to sort the results by */
	sort?: InputMaybe<ManualPaymentConfigSortParameter>;
	/** Takes n results, for use in pagination */
	take?: InputMaybe<Scalars['Int']['input']>;
};

export type ManualPaymentConfigSortParameter = {
	...
	createdAt?: InputMaybe<SortOrder>;
	id?: InputMaybe<SortOrder>;
	ifsc?: InputMaybe<SortOrder>;
	instructionsExtra?: InputMaybe<SortOrder>;
	phone?: InputMaybe<SortOrder>;
	updatedAt?: InputMaybe<SortOrder>;
	upiId?: InputMaybe<SortOrder>;
};
...
export type Query = {
	...
	manualPaymentConfigByCode?: Maybe<ManualPaymentConfig>;
	manualPaymentConfigs: ManualPaymentConfigList;
...
export type QueryManualPaymentConfigsArgs = {
	options?: InputMaybe<ManualPaymentConfigListOptions>;
};
...
export type DetailedProductFragment = {
	...
	name: string;
	description: string;
	customFields?: { __typename?: 'ProductCustomFields'; hsnSac?: string | null } | null;
	collections: Array<{
		__typename?: 'Collection';
		id: string;
		slug: string;
	...
	variants: Array<{
		...
		sku: string;
		stockLevel: string;
		customFields?: { __typename?: 'ProductVariantCustomFields'; hsnSac?: string | null } | null;
		featuredAsset?: { __typename?: 'Asset'; id: string; preview: string } | null;
	}>;
};
...
export function getSdk<C>(requester: Requester<C>) {
	return {
		...
		getPaymentInfo(
			variables: GetPaymentInfoQueryVariables,
			options?: C
		): Promise<GetPaymentInfoQuery> {
			return requester<GetPaymentInfoQuery, GetPaymentInfoQueryVariables>(
				GetPaymentInfoDocument,
				variables,
				options
			) as Promise<GetPaymentInfoQuery>;
		},
		getQrCode(variables: GetQrCodeQueryVariables, options?: C): Promise<GetQrCodeQuery> {
			return requester<GetQrCodeQuery, GetQrCodeQueryVariables>(
				GetQrCodeDocument,
				variables,
				options
			) as Promise<GetQrCodeQuery>;
		},
