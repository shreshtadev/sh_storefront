...
export type PaymentMethodCustomFields = {
  ...
  extraInstructions?: Maybe<Scalars['String']['output']>;
...
export type ProductFilterParameter = {
  ...
  hsnSac?: InputMaybe<StringOperators>;
  id?: InputMaybe<IdOperators>;
  languageCode?: InputMaybe<StringOperators>;
  name?: InputMaybe<StringOperators>;
  slug?: InputMaybe<StringOperators>;
...
export type PublicPaymentMethod = {
  ...
  code: Scalars['String']['output'];
  customFields?: Maybe<PublicPaymentMethodCustomFields>;
  description?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  name: Scalars['String']['output'];
  translations: Array<PaymentMethodTranslation>;
...
export type PublicPaymentMethodCustomFields = {
  __typename?: 'PublicPaymentMethodCustomFields';
  accountName?: Maybe<Scalars['String']['output']>;
  accountNumber?: Maybe<Scalars['String']['output']>;
  bankName?: Maybe<Scalars['String']['output']>;
  branchName?: Maybe<Scalars['String']['output']>;
...
export type Query = {
  ...
  manualPaymentConfigByCode: PaymentMethod;
...
export type QueryManualPaymentConfigByCodeArgs = {
  code: Scalars['String']['input'];
};
...
export type GetPaymentInfoQuery = { __typename?: 'Query', manualPaymentConfigByCode: { __typename?: 'PaymentMethod', code: string, handler: { __typename?: 'ConfigurableOperation', code: string }, customFields?: { __typename?: 'PaymentMethodCustomFields', accountName?: string | null, accountNumber?: string | null, contactNumber?: string | null, bankName?: string | null, branchName?: string | null, ifscCode?: string | null, extraInstructions?: string | null, upiId?: string | null } | null } };

export type GetQrCodeQueryVariables = Exact<{
  upiId: Scalars['String']['input'];
}>;


export type GetQrCodeQuery = { __typename?: 'Query', qrCode: string };
...
export type UpdateCustomerPasswordMutationMutation = { __typename?: 'Mutation', updateCustomerPassword:
    | { __typename: 'InvalidCredentialsError', errorCode: ErrorCode, message: string }
    | { __typename: 'NativeAuthStrategyError', errorCode: ErrorCode, message: string }
    | { __typename: 'PasswordValidationError', errorCode: ErrorCode, message: string }
    | { __typename: 'Success', success: boolean }
...
export type SetCustomerForOrderMutation = { __typename?: 'Mutation', setCustomerForOrder:
...
export type DetailedProductFragment = { __typename?: 'Product', id: string, name: string, description: string, customFields?: { __typename?: 'ProductCustomFields', hsnSac?: string | null } | null, collections: Array<{ __typename?: 'Collection', id: string, slug: string, name: string, breadcrumbs: Array<{ __typename?: 'CollectionBreadcrumb', id: string, name: string, slug: string }> }>, facetValues: Array<{ __typename?: 'FacetValue', id: string, code: string, name: string, facet: { __typename?: 'Facet', id: string, code: string, name: string } }>, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, assets: Array<{ __typename?: 'Asset', id: string, preview: string }>, variants: Array<{ __typename?: 'ProductVariant', id: string, name: string, price: any, currencyCode: CurrencyCode, sku: string, stockLevel: string, customFields?: { __typename?: 'ProductVariantCustomFields', hsnSac?: string | null } | null, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null }> };
...
export type ProductQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, name: string, description: string, customFields?: { __typename?: 'ProductCustomFields', hsnSac?: string | null } | null, collections: Array<{ __typename?: 'Collection', id: string, slug: string, name: string, breadcrumbs: Array<{ __typename?: 'CollectionBreadcrumb', id: string, name: string, slug: string }> }>, facetValues: Array<{ __typename?: 'FacetValue', id: string, code: string, name: string, facet: { __typename?: 'Facet', id: string, code: string, name: string } }>, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, assets: Array<{ __typename?: 'Asset', id: string, preview: string }>, variants: Array<{ __typename?: 'ProductVariant', id: string, name: string, price: any, currencyCode: CurrencyCode, sku: string, stockLevel: string, customFields?: { __typename?: 'ProductVariantCustomFields', hsnSac?: string | null } | null, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null }> } | null };

export type ListedProductFragment = { __typename?: 'SearchResult', productId: string, productName: string, slug: string, currencyCode: CurrencyCode, productAsset?: { __typename?: 'SearchResultAsset', id: string, preview: string } | null, price:
...
export type SearchQuery = { __typename?: 'Query', search: { __typename?: 'SearchResponse', totalItems: number, items: Array<{ __typename?: 'SearchResult', productId: string, productName: string, slug: string, currencyCode: CurrencyCode, productAsset?: { __typename?: 'SearchResultAsset', id: string, preview: string } | null, price:
        | { __typename?: 'PriceRange', min: any, max: any }
        | { __typename?: 'SinglePrice', value: any }
       }>, facetValues: Array<{ __typename?: 'FacetValueResult', count: number, facetValue: { __typename?: 'FacetValue', id: string, name: string, facet: { __typename?: 'Facet', id: string, name: string } } }> } };
...
export const GetPaymentInfoDocument = gql`
  ...
  manualPaymentConfigByCode(code: $code) {
    ...
    `;
export const GetQrCodeDocument = gql`
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    ...
    getPaymentInfo(variables: GetPaymentInfoQueryVariables, options?: C): Promise<GetPaymentInfoQuery> {
      return requester<GetPaymentInfoQuery, GetPaymentInfoQueryVariables>(GetPaymentInfoDocument, variables, options) as Promise<GetPaymentInfoQuery>;
    },
    getQrCode(variables: GetQrCodeQueryVariables, options?: C): Promise<GetQrCodeQuery> {
      return requester<GetQrCodeQuery, GetQrCodeQueryVariables>(GetQrCodeDocument, variables, options) as Promise<GetQrCodeQuery>;
    },
