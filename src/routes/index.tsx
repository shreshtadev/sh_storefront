...
import { APP_STATE, COMPANY_NAME, HOMEPAGE_IMAGE } from '~/constants';
		...
		<div>
			<div class="relative h-[600px]">
				...
				<div class="relative max-w-3xl mx-auto py-32 px-6 flex flex-col items-center text-center sm:py-64 lg:px-0">
					...
					<p class="mt-4 text-2xl text-white">{_`Your one stop shop for all your accessories.`}</p>
				</div>
			</div>
					...
					<div class="-my-2">
						<div class="box-content py-2 px-2 relative overflow-x-auto xl:overflow-visible">
							<div class="sm:px-6 lg:px-8 xl:px-0 pb-4">
								<h2 class="text-2xl font-light tracking-tight text-gray-900">{_`Shop by Category`}</h2>
							</div>
